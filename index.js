...
async function updateDeal(access_token, dealId, dealDataFromTemplate) {
  const dealObject = {
    ...
    Customer_Contact_Number: dealDataFromTemplate.Customer_Contact_Number,
    Religion: dealDataFromTemplate.Religion,
    Phone: dealDataFromTemplate.Customer_Contact_Number,
    Country: dealDataFromTemplate.Country,
    ...
    Metal_Carat: dealDataFromTemplate.Metal_Carat,
    Metal_Rate_pure: dealDataFromTemplate.Metal_Rate_pure,
    Metal_Value: dealDataFromTemplate.Metal_Value,
    Metal_WT: dealDataFromTemplate.Metal_WT,
    Gross_Weight: dealDataFromTemplate.Gross_Weight,
    Net_Weight: dealDataFromTemplate.Net_Weight,
    Stone_Type: dealDataFromTemplate.Stone_Type,
    Stone_Weight: dealDataFromTemplate.Stone_Weight,
    Stone_Rate: dealDataFromTemplate.Stone_Rate,
    Stone_Value: dealDataFromTemplate.Stone_Value,
    Stone_Selling_Rate_Per_Carat: dealDataFromTemplate.Stone_Selling_Rate_Per_Carat,
    Stone_Selling_Value: dealDataFromTemplate.Stone_Selling_Value,
    Diamond_Selling_Rate: dealDataFromTemplate.Diamond_Selling_Rate,
    Diamond_Selling_Value: dealDataFromTemplate.Diamond_Selling_Value,
        Customer_Contact_No: dealDataFromTemplate.Customer_Contact_No,
        Phone: dealDataFromTemplate.Phone,
    Diamond_Size: dealDataFromTemplate.Diamond_Size,
    Diamond_Clarity: dealDataFromTemplate.Diamond_Clarity,
    No_of_Diamonds: dealDataFromTemplate.No_of_Diamonds,
    Making: dealDataFromTemplate.Making,
    Making_Price_1: dealDataFromTemplate.Making_Price_1,
    Making_Price_2: dealDataFromTemplate.Making_Price_2,
    Wastage: dealDataFromTemplate.Wastage,
    Labour_Charges: dealDataFromTemplate.Labour_Charges,
    Polishing_Charges: dealDataFromTemplate.Polishing_Charges,
    Setting_Charges: dealDataFromTemplate.Setting_Charges,
    Misc_Charges: dealDataFromTemplate.Misc_Charges,
    Rhodium_Charges: dealDataFromTemplate.Rhodium_Charges,
    Cost: dealDataFromTemplate.Cost,
    Cost_Code: dealDataFromTemplate.Cost_Code,
    Price_Code: dealDataFromTemplate.Price_Code,
    Tag_Price_1: dealDataFromTemplate.Tag_Price_1,
    Tag_Price_2: dealDataFromTemplate.Tag_Price_2,
    Tag_Price_3: dealDataFromTemplate.Tag_Price_3,
    Tag_line_1: dealDataFromTemplate.Tag_line_1,
    Tag_line_2: dealDataFromTemplate.Tag_line_2,
        Stone_Type: dealDataFromTemplate.Stone_Type,
        Stone_Weight: dealDataFromTemplate.Stone_Weight,
    Tag_line_4: dealDataFromTemplate.Tag_line_4,
    Tag_line_5: dealDataFromTemplate.Tag_line_5,
    Supplier_Name: dealDataFromTemplate.Supplier_Name,
    Supplier_Purchase_Number: dealDataFromTemplate.Supplier_Purchase_Number,
    Supplier_Ref: dealDataFromTemplate.Supplier_Ref,
    Stock_Code: dealDataFromTemplate.Stock_Code,
    Main_Stock_Code: dealDataFromTemplate.Main_Stock_Code,
    Metal_Division: dealDataFromTemplate.Metal_Division,
    Item_Division: dealDataFromTemplate.Item_Division,
    Diamond_Division: dealDataFromTemplate.Diamond_Division,
    Type: dealDataFromTemplate.Type,
    Quantity: dealDataFromTemplate.Quantity,
    PCS: dealDataFromTemplate.PCS,
    Design_Number: dealDataFromTemplate.Design_Number,
    Certificate_Number: dealDataFromTemplate.Certificate_Number,
    Country: dealDataFromTemplate.Country,
  };
...
async function createDeal(access_token, dealDataFromTemplate) {
  const dealObject = {
    ...
    Diamond_Selling_Rate: dealDataFromTemplate.Diamond_Selling_Rate,
    Diamond_Selling_Value: dealDataFromTemplate.Diamond_Selling_Value,
    Diamond_Amount_Per_CT: dealDataFromTemplate.Diamond_Amount_Per_CT,
    DIA_Carat_Weight: dealDataFromTemplate.DIA_Carat_Weight,
    Diamond_Size: dealDataFromTemplate.Diamond_Size,
    Diamond_Clarity: dealDataFromTemplate.Diamond_Clarity,
    No_of_Diamonds: dealDataFromTemplate.No_of_Diamonds,
    Making: dealDataFromTemplate.Making,
    Making_Price_1: dealDataFromTemplate.Making_Price_1,
    Making_Price_2: dealDataFromTemplate.Making_Price_2,
    Making_Price_3: dealDataFromTemplate.Making_Price_3,
    Wastage: dealDataFromTemplate.Wastage,
    Labour_Charges: dealDataFromTemplate.Labour_Charges,
    Polishing_Charges: dealDataFromTemplate.Polishing_Charges,
    Setting_Charges: dealDataFromTemplate.Setting_Charges,
    ...
    Tag_line_1: dealDataFromTemplate.Tag_line_1,
    Tag_line_2: dealDataFromTemplate.Tag_line_2,
    Tag_line_3: dealDataFromTemplate.Tag_line_3,
    Tag_line_4: dealDataFromTemplate.Tag_line_4,
    Tag_line_5: dealDataFromTemplate.Tag_line_5,
    Supplier_Name: dealDataFromTemplate.Supplier_Name,
    Supplier_Purchase_Number: dealDataFromTemplate.Supplier_Purchase_Number,
...
async function createTransaction(access_token, trx) {
  try {
    ...
    const transactionData = {
      ...
      Country: trx.Country,
      Phone: trx.Customer_Contact_Number,
